      ...
      <main className="flex-1 flex flex-col relative pt-24 pb-12 px-4 sm:px-6">
        ...
        <div className="w-full max-w-5xl mx-auto flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-6 pb-4 border-t border-border-color/50">
            <div className="p-6 rounded-2xl bg-surface/30 border border-border-color/50 hover:border-accent/30 transition-colors">
              ...
              <p className="text-base text-foreground-muted leading-relaxed">
                Bypass human-centric storage rate limits and CAPTCHAs. Generate instantly accessible S3 URLs directly from standard agent outputs.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-surface/30 border border-border-color/50 hover:border-accent/30 transition-colors">
              ...
              <p className="text-base text-foreground-muted leading-relaxed">
                Securely pass massive multi-gigabyte files or complex multi-turn context structures between different model instances securely.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-surface/30 border border-border-color/50 hover:border-accent/30 transition-colors">
              ...
              <p className="text-base text-foreground-muted leading-relaxed">
                Solve the enterprise liability gap. We track exact creation times, TTL expirations, and source IPs—creating an undeniable paper trail for autonomous actions.
              </p>
            </div>
          </div>
          ...
          <a
            ...
            className="flex flex-col items-center justify-center p-5 rounded-xl bg-[#5865F2] hover:bg-[#4752C4] text-white transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg group max-w-2xl mx-auto"
          >
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-lg font-bold tracking-tight">Join the Community</span>
            </div>
